...
class ViewController: UIViewController,NowScoreDelegate {
    ...
    override func viewDidLoad() {
        ...
        gradientLayer = cangeColor.cangeColor(topR: 0.07, topG: 0.13, topB: 0.26, topAlpha: 1.0, bottomR: 0.54, bottomG: 0.74, bottomB: 0.74, bottomAlpha: 1.0)
